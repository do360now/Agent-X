...
from generate import gpt_generate_tweet, find_ai_generated_image, grok_generate_topic, grok_generate_post
...
def post_tweet(topic, client, api_v1):
    try:
        ...
        tweet_content = grok_generate_post(topic)
